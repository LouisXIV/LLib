	...
	namespace IO
	{
		namespace BtimapIO
		{
						...
						*/
						...
						//************************************
						// Method:    ReadDIBitmap
						// FullName:  LLib::IO::BtimapIO::ReadDIBitmap
						// Access:    public 
						// Returns:   GLubyte *, the pixels from screen.
						// Qualifier: 
						// Parameter: BITMAPINFO * * info
						// Parameter: int channelNumbers
						//************************************
						GLubyte *ReadDIBitmap(BITMAPINFO **info, int channelNumbers = 3);
